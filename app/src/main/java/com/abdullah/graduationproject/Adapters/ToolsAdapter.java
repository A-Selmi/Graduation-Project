...
public class ToolsAdapter extends RecyclerView.Adapter<ToolsAdapter.DeleteItemsAdapterHolder> {

    Context context;
    List<Items> itemsList;

    public ToolsAdapter(List<Items> itemsList, Context context) {
    ...
    public void onBindViewHolder(@NonNull DeleteItemsAdapterHolder holder, int position) {
        ...
        holder.constraintLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                toDetailsActivity.putExtra("Item", "Tools");
