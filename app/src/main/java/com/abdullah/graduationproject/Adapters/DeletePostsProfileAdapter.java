...
public class DeletePostsProfileAdapter extends RecyclerView.Adapter<DeletePostsProfileAdapter.DeletePostsAdapterHolder> {

    Context context;
    List<Posts> PostsList;
    OnPostClickListener postClickListener;

    public DeletePostsProfileAdapter(List<Posts> PostsList, Context context, OnPostClickListener onPostClickListener) {
    ...
    public DeletePostsAdapterHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.post_custom_profile, parent, false);
